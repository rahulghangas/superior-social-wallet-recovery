...
export default function ThemeProvider({ children }: { children: React.ReactNode }) {
  // TODO: add hook to get light/dark mode from user
  const darkMode = true
...
.electron-pagination ul {
  display: inline-flex;
}

.electron-pagination li {
...
.electron-pagination li.rc-pagination-item-active {
  border: solid 1px ${props => props.theme.bg4};
}

.electron-pagination li.rc-pagination-prev,
.electron-pagination li.rc-pagination-next {
  color: ${props => props.theme.white};
  padding-top: 2px;
}

.electron-pagination li.rc-pagination-options {
  display: none;
}

.electron-pagination li.rc-pagination-disabled {
  border: solid 1px ${props => props.theme.bg3};
